...
\lstinputlisting[
  style=cpp,
  caption={Obtains the area of a polygon formed by a set of Points (2D) stored in a \texttt{std::vector}. It returns a double, since it has a division by 2, but it can return a \texttt{ll} for double the area. Requires the \texttt{Point} struct seen in the previous listing.},
