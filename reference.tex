...
\lstinputlisting[
  style=cpp,
  caption={Lazy Propagation Segment Tree for Range Updates \textbf{Zum} Queries.},
...
\lstinputlisting[
  style=cpp,
  caption={Calculates the lenght of Tree Diameter using a DP approach. Runs in $O(|V|)$.},
